<?php include('includes/header.php'); 
	...
	if(isset($_GET['status_active_id']))
	{
		...
		$edit_status=Update('tbl_service', $data, "WHERE s_id = '".$_GET['status_active_id']."'");
        ...
        <div class="card mrg_bottom">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">Manage Service</div>
            </div>
              ...
              <tbody>
                ...
                <tr>
		           ...
		           <td>
		              ...
		              <a href="manage_service.php?status_deactive_id=<?php echo $users_row['s_id'];?>" title="Change Status"><span class="badge badge-success badge-icon"><i class="fa fa-check" aria-hidden="true"></i><span>Enable</span></span></a>

		              <?php }else{?>
		              <a href="manage_service.php?status_active_id=<?php echo $users_row['s_id'];?>" title="Change Status"><span class="badge badge-danger badge-icon"><i class="fa fa-check" aria-hidden="true"></i><span>Disable </span></span></a>
		              <?php }?>
              		</td>
                   <td><a href="add_service.php?s_id=<?php echo $users_row['s_id'];?>" class="btn btn-primary">Edit</a>
                    <a href="manage_service.php?s_id=<?php echo $users_row['s_id'];?>" onclick="return confirm('Are you sure you want to delete this user?');" class="btn btn-default">Delete</a></td>
                </tr>
               <?php
