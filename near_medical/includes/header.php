      ...
      <ul class="sidebar-nav">
        <li <?php if($currentFile=="home.php"){?>class="active"<?php }?>> <a href="home.php">
         ...
         <li <?php if($currentFile=="manage_category.php" or $currentFile=="add_category.php"){?>class="active"<?php }?>> <a href="manage_category.php">
          ...
          <div class="title">main cat</div>
          </a> 
        </li>
        
        <li <?php if($currentFile=="manage_doctor_cat.php" or $currentFile=="add_doctor_cat.php"){?>class="active"<?php }?>> <a href="manage_doctor_cat.php">
          <div class="icon"> <i class="fa fa-sitemap" aria-hidden="true"></i> </div>
          <div class="title">doc cat</div>
          </a> 
        </li>
        
         <li <?php if($currentFile=="manage_doctor_list.php" or $currentFile=="add_doctor_list.php" or $currentFile=="add_doctor_list.php"){?>class="active"<?php }?>> <a href="manage_doctor_list.php">
          <div class="icon"> <i class="fa fa-film" aria-hidden="true"></i> </div>
          <div class="title">doc list</div>
          </a> 
        </li> 
        <li <?php if($currentFile=="manage_location.php"){?>class="active"<?php }?>> <a href="manage_location.php">
