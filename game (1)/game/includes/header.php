  ...
  <aside class="app-sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
      <ul class="sidebar-nav">
        ...
        <li <?php if($currentFile=="manage_market.php"){?>class="active"<?php }?>> <a href="manage_market.php">
          <div class="icon"> <i class="fa fa-dashboard" aria-hidden="true"></i> </div>
          <div class="title">Market</div>
          </a> 
        </li>

   <li <?php if($currentFile=="manage_bat.php"){?>class="active"<?php }?>> <a href="manage_bat.php">
          <div class="icon"> <i class="fa fa-dashboard" aria-hidden="true"></i> </div>
