<?php include("includes/header.php");
   ...
   else
   {
     ...
     $quotes_qry="SELECT * FROM tbl_video
                ...
                <div class="block_wallpaper">
                  <div class="wall_category_block">
                    ...
                    <?php if($row['featured']!="0"){?>
                         <a href="manage_videos.php?featured_deactive_id=<?php echo $row['id'];?>" data-toggle="tooltip" data-tooltip="Featured"><div style="color:green;"><i class="fa fa-check-circle"></i></div></a> 
                      <?php }else{?>
                         <a href="manage_videos.php?featured_active_id=<?php echo $row['id'];?>" data-toggle="tooltip" data-tooltip="Set Featured"><i class="fa fa-circle"></i></a> 
                      <?php }?>
                  </div>
