<?php include("includes/header.php");
	...
	if(isset($_GET['cat_id']))
	{
			...
			$qry="SELECT * FROM tbl_category where id='".$_GET['cat_id']."'";
	...
	if(isset($_POST['submit']) and isset($_POST['cat_id']))
	{
		 ...
		 {		
				...
				$img_res=mysqli_query($mysqli,'SELECT * FROM tbl_category WHERE id='.$_GET['cat_id'].'');
		 ...
		 else
		 {
			         ...
			         $category_edit=Update('tbl_category', $data, "WHERE id = '".$_POST['cat_id']."'");
