<?php include("includes/header.php");
  ...
  $qry="SELECT * FROM tbl_fullscreen_video where id='".$_GET['video_id']."'";
  ...
  $row=mysqli_fetch_assoc($result);
    ...
    $qry=Update('tbl_fullscreen_video', $data, "WHERE id = '".$_POST['video_id']."'");

         
		$_SESSION['msg']="11"; 
		header( "Location:edit_fullscreenvideo.php?video_id=".$_POST['video_id']);
		exit;	
                    ...
                    <div class="col-md-6">
                      <div class="fileupload_block">
                       ...
                       <input type="hidden" name="video_thumbnail_name" id="video_thumbnail_name" value="<?php echo $row['video_thumbnail'];?>" class="form-control">
                            <div class="fileupload_img"><img type="image" src="images/<?php echo $row['video_thumbnail'];?>" alt="video thumbnail" /></div>
                          <?php } else {?>
