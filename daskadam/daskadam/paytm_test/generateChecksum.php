...
// $checkSum = getChecksumFromArray($paramList,'aiRGiZRNuNrvDB9G');
//   $checkSum = getChecksumFromArray($paramList,'AmgwJA45123063672462');
// $checkSum = getChecksumFromArray($paramList,'&0VMDO2c8d0&WhwE');
$checkSum = getChecksumFromArray($paramList,'AK2lwI4s4XjBeMll');
