    ...
    {        
            ...
            copy($pic1,$tpath1);
              ...
              'payment_desc'  =>  $_POST['payment_desc'], 
                'activeidtext'  =>  $_POST['activeidtext'], 
              ...
              <div class="section">
                <div class="section-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="points" id="points" value="<?php echo $settings_row['points'];?>" class="form-control">
                    </div>
                  </div> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="coin" id="coin" value="<?php echo $settings_row['coin'];?>" class="form-control">
                    </div>
                  </div> 
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="price" id="price" value="<?php echo $settings_row['price'];?>" class="form-control">
                    </div>
                  </div> 
                    ...
                    <div class="col-md-6">
                      <input type="text" name="payment" id="payment" value="<?php echo $settings_row['payment'];?>" class="form-control">
                    </div>
                  </div> 
                    <div class="form-group">
                    ...
                    <div class="col-md-6">
                         ...
                         <textarea name="payment_desc" id="payment_desc" class="form-control"><?php echo $settings_row['payment_desc'];?></textarea>

                      <script>CKEDITOR.replace( 'payment_desc' );</script>
                    </div>
                  </div> 
                  <div class="form-group">
                    <label class="col-md-3 control-label">Active Text :-</label>
                    <div class="col-md-6">
                      <input type="text" name="activeidtext" id="activeidtext" value="<?php echo $settings_row['activeidtext'];?>" class="form-control">
                    </div>
                  </div> 
          ...
          <div class="section-body">            
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                ...
                <div class="banner_ads_block">
                  <div class="banner_ad_item">
                    <label class="control-label">Rewarded Ads :-</label>                                  
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="col-md-3 control-label">Rewarded Ad:-</label>
                      <div class="col-md-9">
                       <select name="Rewarded_ad" id="Rewarded_ad" class="select2">
                                <option value="true" <?php if($settings_row['Rewarded_ad']=='true'){?>selected<?php }?>>True</option>
                                <option value="false" <?php if($settings_row['Rewarded_ad']=='false'){?>selected<?php }?>>False</option>
                    ...
                    <div class="form-group">
                      <label class="col-md-3 control-label mr_bottom20">Banner ID :-</label>
                      <div class="col-md-9">
                      <input type="text" name="Rewarded_ad_id" id="Rewarded_ad_id" value="<?php echo $settings_row['Rewarded_ad_id'];?>" class="form-control">
                      </div>
                    </div>                    
                  </div>
                </div>  
