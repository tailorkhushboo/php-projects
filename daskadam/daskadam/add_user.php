<?php include('includes/header.php');
	...
	{		
			...
			'phone'  =>  $_POST['phone'],
			'wallet'  =>  $_POST['wallet'],
// 			'refer_wallet'  =>  $_POST['refer_wallet'],
			);
            ...
            <form action="" name="addedituser" method="post" class="form form-horizontal" enctype="multipart/form-data" >
              ...
              <div class="section">
                <div class="section-body">
                  ...
                  <!--<div class="form-group">-->
                  <!--  <label class="col-md-3 control-label">Refer Wallet :-</label>-->
                  <!--  <div class="col-md-6">-->
                  <!--    <input type="text" name="refer_wallet" id="refer_wallet" value="<?php if(isset($_GET['user_id'])){echo $user_row['refer_wallet'];}?>" class="form-control">-->
                  <!--  </div>-->
                  <!--</div>-->
