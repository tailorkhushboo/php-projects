...
//cid	c_name	c_image	c_price	c_status
	...
	if(isset($_GET['t_id']))
	{
			...
			$qry="SELECT * FROM tbl_toppings where t_id='".$_GET['t_id']."'";
	...
	{		 	
     ...
     {   
         ...
         $img_res=mysqli_query($mysqli,'SELECT * FROM tbl_toppings WHERE t_id='.$_POST['t_id'].'');
       ...
       $category_edit=Update('tbl_toppings', $data, "WHERE t_id = '".$_POST['t_id']."'");
        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title"><?php if(isset($_GET['t_id'])){?>Edit<?php }else{?>Add<?php }?> Topping</div>
            </div>
          </div>
              ...
              <div class="section">
                <div class="section-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="t_name" id="t_name" value="<?php if(isset($_GET['t_id'])){echo $row['t_name'];}?>" class="form-control" required>
                    </div>
                  </div>
