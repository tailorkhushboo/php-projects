...
//cid	c_name	c_image	c_price	c_status
    ...
    //Thumb Image 
     $thumbpath='images/thumbs/'.$banner_image;   
      ...
      //t_id	t_name	t_image	t_reg_price	t_mid_price	t_lar_price	t_status
  		 $data = array(
	...
	if(isset($_GET['c_id']))
	{
			...
			$qry="SELECT * FROM tbl_cheez where c_id='".$_GET['c_id']."'";
	...
	{		 	
     ...
     {   
         ...
         $img_res=mysqli_query($mysqli,'SELECT * FROM tbl_cheez WHERE c_id='.$_POST['c_id'].'');
       ...
       $category_edit=Update('tbl_cheez', $data, "WHERE c_id = '".$_POST['c_id']."'");
        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title"><?php if(isset($_GET['c_id'])){?>Edit<?php }else{?>Add<?php }?> Cheez </div>
            </div>
          </div>
              ...
              <div class="section">
                <div class="section-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="c_name" id="c_name" value="<?php if(isset($_GET['c_id'])){echo $row['c_name'];}?>" class="form-control" disabled required>
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="c_reg_price" id="c_reg_price" value="<?php if(isset($_GET['c_id'])){echo $row['c_reg_price'];}?>" class="form-control" required>
                    </div>
                  </div>
                     <div class="form-group">
                    <label class="col-md-3 control-label">Medium Price :-</label>
                    <div class="col-md-6">
                      <input type="text" name="c_mid_price" id="c_mid_price" value="<?php if(isset($_GET['c_id'])){echo $row['c_mid_price'];}?>" class="form-control" >
                    </div>
                  </div>
                     <div class="form-group">
                    <label class="col-md-3 control-label">Large Price :-</label>
                    <div class="col-md-6">
                      <input type="text" name="c_lar_price" id="c_lar_price" value="<?php if(isset($_GET['c_id'])){echo $row['c_lar_price'];}?>" class="form-control" >
                    </div>
                  </div>
