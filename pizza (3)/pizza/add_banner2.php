<?php include("includes/header.php");
	...
	if(isset($_GET['b_id']))
	{
			...
			$qry="SELECT * FROM tbl_banner2 where b_id=1";
	...
	{		 	
     ...
     {   
         ...
         $img_res=mysqli_query($mysqli,'SELECT * FROM tbl_banner2 WHERE b_id='.$_POST['b_id'].'');
       ...
       $category_edit=Update('tbl_banner2', $data, "WHERE b_id = '".$_POST['b_id']."'");
        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title"><?php if(isset($_GET['b_id'])){?>Edit<?php }else{?>Add<?php }?>New Banner</div>
            </div>
          </div>
